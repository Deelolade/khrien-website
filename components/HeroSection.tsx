            ...
            <div className="flex justify-between items-center py-10 flex-col md:flex-row gap-10">
                <div className="text-black space-y-6 w-full md:w-[48%]">
                    ...
                    <div className="flex gap-4 items-center">
                        <Link href="#" className="inline-block border-5 rounded-full border-r border-t border-black font-semibold bg-brandYellow px-10 py-3 hover:bg-brandPurple hover:text-white transition-all duration-50 ease-in-out" aria-label="Get Started">Get Started</Link>
                        <Link href="#" className="inline-block border-5 rounded-full border-r border-t border-black font-semibold bg-white px-10 py-3 hover:bg-brandPurple hover:text-white transition-all duration-50 ease-in-out" aria-label="Get Started">Explore Solutions</Link>
                    </div>
                </div>
                <div className="w-full md:w-[48%]">
                    <Image src={heroImageTwo} alt="Hero" className='w-full h-auto scale-125' />
                </div>
            </div>
        </div>
    )
