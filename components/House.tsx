    ...
    return (
        <>
            <motion.section
                ...
                className="max-w-360 mx-auto bg-brandGray my-6 shadow-sm rounded-3xl p-8 md:p-16 md:pr-0 md:pb-0 pr-0  overflow-hidden"
            >
                <div className="flex flex-col md:flex-row justify-between items-end gap-10">
                    <div className="w-full md:w-1/2 py-8 md:py-20 text-center md:text-left">
                    ...
                    <div className="w-full md:w-1/2 relative">
                        ...
                        >
                            <Image src={HouseImage} className="w-full h-full object-cover scale-150" alt=''></Image>
                        </motion.div>
                    </div>
                </div>
            </motion.section>
                ...
                >
                    <div className="flex flex-wrap w-full justify-center md:justify-between items-center gap-6 md:gap-0">
                        <div className="text-center">
                            <h1 className="text-3xl md:text-5xl text-brandYellow">Foundation</h1>
                        </div>
                        <Image src={HouseIcon} className="hidden md:block size-16 object-cover" alt=''></Image>
                        <div className="text-center">
                            <h1 className="text-3xl md:text-5xl text-brandYellow">Structure</h1>
                        </div>
                        <Image src={HouseIcon} className="hidden md:block size-16 object-cover" alt=''></Image>
                        <div className="text-center">
                            <h1 className="text-3xl md:text-5xl text-brandYellow">Occupancy</h1>
                        </div>
                    </div>
                </motion.div>
            </section>
