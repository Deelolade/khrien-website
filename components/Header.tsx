...
const Header = () => {
  return (
    <header className='flex justify-between items-center h-[9vh] max-w-360 mx-auto bg-amber-50 shadow-sm text-black my-6 px-6 rounded-2xl'>
      ...
      <div className="px-4">
        <div className="border-5 rounded-full border-r border-t border-black bg-[#f7a619] px-10 py-3 hover:bg-[#934ab3] hover:text-white transition-all duration-50 ease-in-out">
